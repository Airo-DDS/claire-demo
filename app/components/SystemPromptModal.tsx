  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant={buttonVariant} size="sm" className="flex items-center gap-1">
      ...
      <DialogContent className="sm:max-w-[650px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="p-4 bg-slate-50 rounded-md border border-slate-200 my-4 max-h-[60vh] overflow-y-auto">
          <pre className="text-sm whitespace-pre-wrap text-slate-700 font-mono">
            {/* Placeholder text for the system prompt */}
            [Identity]
